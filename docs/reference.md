...
These commands can be used in IDEs that support agent commands (e.g., Claude Code's `/command` syntax):

| Command | Description | Defined in |
|---------|-------------|------------|
| `/add_project <name> <path>` | Plug in a project | `ai/commands/add_project.md` |
| `/remove_project <name>` | Unplug a project | `ai/commands/remove_project.md` |
...
| `plan_inicial.md` | Sensitive planning document |
