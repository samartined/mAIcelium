...
When you run `bin/add_project.py my-api ~/dev/my-api`:
...
When you run `bin/remove_project.py my-api`:
...
|------|-------------|---------|
| `WORKSPACE.md` | `add_project.py` / `remove_project.py` | Lists active projects with paths and timestamps |
| `.claude/projects-context.md` | `_lib.py` → `_regenerate_claude_context()` | Lists rules and skills of active projects for Claude Code |
